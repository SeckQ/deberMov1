...
const twitter = <Icon name={'x-twitter'} size={30} color={'blue'} />;
const linkedin = <Icon name={'linkedin-in'} size={30} color={'blue'} />;
const reddit = <Icon name={'reddit-alien'} size={30} color={'blue'} />;
